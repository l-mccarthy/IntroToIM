...
Despite me labelling this project as "complete" on the last update, soliciting user feedback did open an opportunity to tweak the project. Despite the minimal instructions I gave on the menu screen, I was pleased with how the players intuitively figured out the mechanics of the game on their first try. This is probably because arrow keys are universal signifiers when it comes to movement in video game design. Almost everyone found the game to be stressful and challenging to some degreee, but fun enough, I assume, that they immediately restarted the game to try again and determinedly beat their previous highscore. I also became aware of how this highscore dynamic makes for compelling competition between more than one player as we compare highscores. The only criticism I recieved was that they questioned what both numbers near the top of the screen were, so I had to explain the one on the left is the level you are currently on and on the right is your highscore. Consequently, I added respective "highscore" and "level" text above those numbers to clarify. I am thrilled with the overall positive response my game garnered from my peers.
